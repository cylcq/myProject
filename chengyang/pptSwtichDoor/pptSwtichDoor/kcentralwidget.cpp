...
{
	 /*delete m_pSwitchWidget;
	 delete m_pSpinBoxDuration;
	 delete m_pLabelDuration;*/
}
...
void KCentralWidget::setWindowWidgetSize()
{
	m_pLabelDuration->setGeometry(m_nMainWindowWide * 0.6, m_nMainWindowHeight * 0.02,
		m_nMainWindowWide * 0.2, m_nMainWindowHeight * 0.08);

	m_pSpinBoxDuration->setGeometry(m_nMainWindowWide * 0.8, m_nMainWindowHeight * 0.02,
		m_nMainWindowWide * 0.19, m_nMainWindowHeight * 0.08);
...
void KCentralWidget::switchDoor()
{
