...
float windY=0.20f;
float windZ=0.01f;
float damping=0.00f; //how much to damp the cloth simulation each frame
int springConstraintCalculations = 5; //how many springConstraint calculations occur each time step
bool colorFlagUSA=true;
